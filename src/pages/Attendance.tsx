...
import { ChevronLeft, ChevronRight, Users, CheckCircle, XCircle, Clock, Calendar, ArrowLeft } from 'lucide-react';
...
const Attendance: React.FC = () => {
  ...
  const selectedClass = searchParams.get('class') || '9A';
  const selectedSession = searchParams.get('session') || 'morning';

  useEffect(() => {
    if (!searchParams.get('class') || !searchParams.get('session')) {
    ...
    <div className="page-container max-w-lg mx-auto animate-fade-in">
      ...
      <div className="mb-4">
        <div className="flex items-center justify-between bg-gray-50 p-3 rounded-lg">
          <div>
            <h2 className="font-medium text-gray-800">Class {selectedClass}</h2>
            <p className="text-sm text-gray-600 capitalize">{selectedSession} Session</p>
          </div>
